      ...
      <div v-else>
        ...
        <div class="space-y-4 sm:space-y-6">
          ...
          <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <h3 class="text-xl sm:text-3xl font-extrabold text-gray-900 dark:text-gray-100 break-words">{{ task.nombre_tarea }}</h3>
          ...
          <div v-if="task.descripcion">
            ...
            <div class="mt-1 p-2 border border-gray-200 dark:border-gray-600 rounded-md text-gray-700 dark:text-gray-200 text-sm sm:text-base max-h-28 sm:max-h-32 overflow-y-auto">
              {{ task.descripcion }}
            </div>
          </div>
