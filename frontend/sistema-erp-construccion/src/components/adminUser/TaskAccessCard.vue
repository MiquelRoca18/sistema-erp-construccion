<template>
  <router-link to="/tasks-admin" class="block">
    <div class="p-6 bg-gradient-to-r from-orange-100 to-orange-200 dark:from-orange-800 dark:to-orange-900 rounded-lg shadow-lg transform transition hover:scale-105">
