<template>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-lg w-full overflow-hidden transform transition-all duration-300">
        ...
        <div class="bg-gradient-to-r from-yellow-500 to-yellow-400 p-4 rounded-t-2xl">
          <div class="flex justify-between items-center">
            <h2 class="text-white text-2xl font-bold">Crear Presupuesto</h2>
        ...
        <form @submit.prevent="handleSubmit" class="p-6 space-y-6">
          <div class="mb-4">
            ...
            <input
              ...
              type="number"
              required
              class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-yellow-400 dark:focus:ring-yellow-300"
            />
          </div>
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      errorMessage.value = error.message || 'Error al crear presupuesto';
    }
  };
  </script>
