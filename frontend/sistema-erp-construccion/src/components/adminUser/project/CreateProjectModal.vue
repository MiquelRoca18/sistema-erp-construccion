    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden transform transition-all duration-300">
      ...
      <div class="bg-gradient-to-r from-green-500 to-green-400 dark:from-green-700 dark:to-green-600 p-3 sm:p-4 rounded-t-2xl">
        <div class="flex justify-between items-center">
          <h2 class="text-white text-xl sm:text-2xl font-bold">Crear Nuevo Proyecto</h2>
          <button 
            @click="closeModal" 
      ...
      <form v-else @submit.prevent="handleSubmit" class="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        <!-- Mensaje de error -->
        <div v-if="errorMessage" class="mb-3 sm:mb-4 p-2 sm:p-3 bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-200 border border-red-300 dark:border-red-700 rounded-lg flex items-center text-xs sm:text-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 sm:h-5 sm:w-5 mr-1 sm:mr-2 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex justify-end space-x-2">
          ...
          <button 
            ...
            class="px-3 sm:px-4 py-1.5 sm:py-2 bg-green-600 text-white rounded hover:bg-green-700 transition text-xs sm:text-sm dark:bg-green-500 dark:hover:bg-green-600
                  disabled:opacity-70 disabled:cursor-not-allowed 
