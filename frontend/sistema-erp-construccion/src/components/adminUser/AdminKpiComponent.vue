  ...
  <div class="p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="flex flex-col items-center">
        ...
        <p class="mt-3 text-xl font-bold text-blue-800">{{ totalEmployees }}</p>
      ...
      <div class="flex flex-col items-center">
        ...
        <p class="mt-3 text-xl font-bold text-green-800">{{ totalProjects }}</p>
      ...
      <div class="flex flex-col items-center">
        <div class="w-20 h-20 bg-orange-200 rounded-full flex items-center justify-center">
          <svg class="w-10 h-10 text-orange-800" fill="currentColor" viewBox="0 0 24 24">
            <path d="M19 3H5c-1.1 0-2 .9-2 2v14l4-4h12c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/>
          </svg>
        </div>
        <p class="mt-3 text-xl font-bold text-orange-800">{{ totalTasks }}</p>
        <p class="text-gray-500">Tareas</p>
      </div>
      
      <!-- KPI: Presupuesto Total -->
      <div class="flex flex-col items-center">
        <div class="w-20 h-20 bg-amber-200 rounded-full flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-amber-800" viewBox="0 0 24 24" fill="currentColor">
        ...
        <p class="mt-3 text-xl font-bold text-amber-800">{{ totalBudgetFormatted }}</p>
        <p class="text-gray-500">Presupuesto Total</p>
      </div>
    </div>
  </div>
</template>
